...
let
  cfg = config.packages.zsh;
in
{

  options.packages.zsh = {
    enable = lib.mkEnableOption "Enable and set zsh for user";
    user = lib.mkOption {
      type = lib.types.str;
      default = null;
      description = "user to enable zsh for";
    };
  };
  ...
  config = lib.mkIf cfg.enable {
    ...
    programs.zsh = {
      ...
      '';
      setOptions = [
        # This is kinda annoying but I'm too used to this...
        "AUTO_CD"
